...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="#" class="scroll-link" data-id="">Mis Propuestas</a></li>
      <li><a href="#" class="scroll-link" data-id="">FAQs</a></li>
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome <strong>participante</strong> <b class="caret"></b></a>
