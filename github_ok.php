	  ...
	  <div class="modal-dialog" style="margin-top: 150px;">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" id="login_details">
  	        ...
  	        <input type="email" placeholder="example@correounivalle.edu.co" name="login_correo" /><br /><br />
  	        <span style="font-weight:bold;" >*Contraseña</span><br />
  	        <input type="password" placeholder="Password" name="login_contraseña" /><br />
            <span id="error_Login"></span><br />
	      </div>
	      <div class="modal-footer" >
  			    <input style="float: left" type="button" class="btn btn-success" value="Iniciar Sesión" />
  	        <span style="padding-right: 12px">Iniciar sesión con:</span>
  			    <a onClick="facebookLogin()" class="btn btn-social-icon btn-facebook">
  				    <i class="fa fa-facebook"></i>
  			    </a>
            <!--loginTwitterApi/loginToTwitter.php-->
  			    <a href="vista/web/loginTwitter/redirect.php" class="btn btn-social-icon btn-twitter">
	  ...
	  <div class="modal-dialog" style="margin-top: 100px;">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" id="signup_details">
	        ...
	        <input type="text" placeholder="Escriba su nombre completo" name="registro_nombre" /> </br></br>
          <span >*Correo institucional</span>
	        <input type="email" placeholder="example@coreounivalle.edu.co" name="registro_correo" /></br></br>
          <span >*Alias</span>
          <input type="text" name="registro_nick" /> </br></br>
	        <span >*Contraseña</span>
	        <input type="password" placeholder="Escriba su contraseña" name="registro_contrasenia" /></br></br>
	        <span >*Repetir contraseña</span>
	        <input type="password" placeholder="Repita su contraseña" name="re_reg_contrasenia" /> </br></br>
          ...
          <input type="text" placeholder="username" name="registro_twitter" /> </br></br>
          <span>* Campos obligatorios</span>
          <span id="error_registro"></span>
	      </div>
	      <div class="modal-footer" >
      		<input style="float: left" type="button" class="btn btn-success" value="Registrarme" name="Registrarme" id="registro"/> 
